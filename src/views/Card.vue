                ...
                <div class="popup-title">
                    ...
                    <div class="popup-title-text">
                        <textarea
                            ...
                            @blur="editCardName"
                            @keydown.enter.prevent="enterToBlur"
                            ref="newCardName"
                        >{{card.name}}</textarea>
                    </div>
                ...
                <div class="window-module">
                    ...
                    <div class="title">
                        ...
                        <div class="title-text">
                            <h3>描述</h3>
                            <button class="btn btn-edit" @click="$refs.cardDescription.focus()">编辑</button>
                        </div>
                    </div>
    ...
    methods: {
        editCardName(e) {
            this.$utils.blurToEditTextarea({
                ...
                event: e,
                emptyMsg: '卡片名称不能为空哦',
                successMsg: '卡片名称修改成功啦',
                actionName: 'card/editCard',
                data: {
                    id: this.card.id,
                    name: e.target.value
                }
        ...
        async uploadAttachment() {
            ...
            try {
                ...
                // 处理上传同一个文件时不会触发change的问题
                this.$refs.attachment.value = '';
                this.$message.success('附件上传成功啦');
            } catch (e) {}
        },
        // 删除附件
